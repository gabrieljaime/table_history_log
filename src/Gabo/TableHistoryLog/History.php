...
class History extends Eloquent
{
    ...
    {
        $related_model = $this->history_type;
    ...
    {
        if (class_exists($class = $this->history_type)) {
            return $class::find($this->history_id);
        }
