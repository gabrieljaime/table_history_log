<?php namespace Gabo\TableHistoryLog;

use Illuminate\Database\Eloquent\Model as Eloquent;

/*
 * This file is part of the Historical package by 
 *
 *
 */
...
/**
 * Class Historical
 * @package Gabo\table-history-log
 */
class Historical extends Eloquent
{
    /**
     * @var
     */
    ...
    {
        return $this->morphMany('\Gabo\table_history_log\History', 'revisionable');
    }
    ...
    */
    ...
    public function postDelete()
    {
        if ((!isset($this->revisionEnabled) || $this->revisionEnabled)
            ...
            $history = new \Gabo\table_history_log\History();
            \DB::table($history->getTable())->insert($histories);
        }
    }
